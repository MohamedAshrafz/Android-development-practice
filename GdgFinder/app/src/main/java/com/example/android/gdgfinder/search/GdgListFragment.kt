...
class GdgListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.regionList.observe(viewLifecycleOwner, Observer { list ->
            list?.apply {
                val chipGroup = binding.regionsList
                val chipInflater = LayoutInflater.from(chipGroup.context)

                val children: List<Chip> = list.map { regionString ->
                    val chip = chipInflater.inflate(R.layout.chip_region, chipGroup, false) as Chip
                    chip.text = regionString
                    chip.tag = regionString
...
//                val chipInflater = LayoutInflater.from(chipGroup.context)
//
//                val children: List<Chip> = data.map { regionString ->
//                    val chip = chipInflater.inflate(R.layout.chip_region, chipGroup, false) as Chip
//                    chip.text = regionString
//                    chip.tag = regionString
//
