...
const val hoursExpression = 1000 * 60 * 60
const val minutesExpression = 1000 * 60
const val secondsExpression = 1000
    ...
    sb.apply {
        ...
        nights.forEach {
            ...
            if (it.endTimeMilli != it.startTimeMilli) {
                var time = it.endTimeMilli.minus(it.startTimeMilli)
                ...
                // Hours
                var hours: Long = time / hoursExpression
                append("\t ${hours}:")
                time -= hours * hoursExpression
                // Minutes
                var minutes: Long = time / minutesExpression
                append("${minutes}:")
                time -= minutes * minutesExpression
                // Seconds
                var seconds = time / secondsExpression
