...
class DessertTimer(lifecycle: Lifecycle) : LifecycleObserver {
    ...
    // using observer pattern on observing the LifeCycle of an activity
    // LifeCycle is the part of LifeCycle library on androidX (jetpack compose)
    @OnLifecycleEvent(Lifecycle.Event.ON_START)
    fun startTimer() {
        // Create the runnable action, which prints out a log and increments the seconds counter
        Timber.i("startTimer was called")
        runnable = Runnable {
            secondsCount++
